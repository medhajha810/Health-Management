...
1. Open the application and click "Sign Up" or "Login" to authenticate using Internet Identity or connect your Flow wallet.
2. Complete your profile information.
3. Link your ABHA ID (optional).
4. Link your Flow wallet (optional, recommended for blockchain features).
...
- **Authentication**: Internet Identity and Flow blockchain for secure, anonymous authentication
...
This application uses the Flow blockchain for secure account linking and health record management. Your Flow wallet address can be linked to your profile for enhanced security and interoperability.

### Flow Wallet Recovery
- Always keep your Flow wallet recovery phrase safe. This is the only way to recover your Flow-linked account if you lose access.
- If you unlink your Flow wallet, you can re-link it at any time using the same address.
- For more information, visit [Flow Wallet Recovery Guide](https://developers.flow.com/tools/wallets).
